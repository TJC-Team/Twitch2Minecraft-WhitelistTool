...
export declare type BasicTcpTransportConfiguration = Omit<TcpTransportConfiguration, "host" | "port">;
...
export declare type TransportConfiguration = DuplexTransportConfiguration | TcpTransportConfiguration | BasicTcpTransportConfiguration | WebSocketTransportConfiguration | PresetWebSocketTransportConfiguration;
export declare type CustomRateLimitsConfig = MessageRateLimits;
export declare type RateLimitsConfig = PresetKeys | CustomRateLimitsConfig;
