                ...
                return tslib_1.__generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1:
                            {
                                match = message.split(' ');
                                user = match && /^\w+$/.test(match[0]) ? match[0] : undefined;
                                if (user) {
                        ...
                        case 3:
                            {
                                this.emit(this._onBanResult, channel, UserTools_1.toUserName(channel), messageType);
                                return [3 /*break*/, 59];
                            }
                            _g.label = 4;
                        case 4:
                            {
                                match = message.match(/^You cannot ban (?:\w+ )+?(\w+)\.$/);
                                if (match) {
                        ...
                        case 23:
                            {
                                match = message.match(/^You have added (\w+) /);
                                if (match) {
                        ...
                        case 25:
                            {
                                match = message.match(/^You have removed (\w+) /);
                                if (match) {
                        ...
                        case 27:
                            {
                                _d = tslib_1.__read(message.split(': '), 2), modList = _d[1];
                                mods = modList.split(', ');
                        ...
                        case 37:
                            {
                                this.emit(this._onTimeoutResult, channel, UserTools_1.toUserName(channel), undefined, messageType);
                                return [3 /*break*/, 59];
                            }
                            _g.label = 38;
                        case 38:
                            {
                                match = message.match(/^You cannot timeout moderator (\w+) unless/);
                                if (match) {
                                    this.emit(this._onTimeoutResult, channel, UserTools_1.toUserName(match[1]), undefined, messageType);
                                }
                                return [3 /*break*/, 59];
                            }
                            _g.label = 39;
                        ...
                        case 45:
                            {
                                _e = tslib_1.__read(message.split(': '), 2), vipList = _e[1];
                                vips = vipList.split(', ');
                        ...
                        case 54:
                            ...
                            if (secs !== 0) {
                                (_f = this._chatLogger) === null || _f === void 0 ? void 0 : _f.info("Retrying authentication in " + secs + " seconds");
                            }
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var e = _this._onFollowersOnlyResult(function (_channel, _minFollowTime, error) {
                            if (UserTools_1.toUserName(_channel) === channel && _minFollowTime === minFollowTime) {
                                if (error) {
                                    reject(error);
                                }
                                else {
                        ...
                        _this.say(channel, "/followers " + (minFollowTime || ''));
                    })];
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.say(channel, "/slow " + delayBetweenMessages);
                    })];
            });
        });
    };
    ...
    ChatClient.prototype.quit = function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                (_a = this._connection) === null || _a === void 0 ? void 0 : _a.disconnect().then(function () {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, twitch_auth_1.getTokenInfo(this._authToken.accessToken)];
                    case 3:
                        token = _e.sent();
                        this._updateCredentials({
                            nick: token.userName
