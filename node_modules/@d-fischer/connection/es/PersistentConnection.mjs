    ...
    PersistentConnection.prototype.connect = function () {
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        (_a = this._logger) === null || _a === void 0 ? void 0 : _a.trace("PersistentConnection connect currentConnectionExists:" + !!this._currentConnection + " connecting:" + this._connecting);
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        ...
                                        if (secs !== 0) {
                                            (_b = this_1._logger) === null || _b === void 0 ? void 0 : _b.info("Retrying in " + secs + " seconds");
                                        }
                                        return [4 /*yield*/, delay(secs * 1000)];
                                    case 4:
                                        _a.sent();
                                        (_c = this_1._logger) === null || _c === void 0 ? void 0 : _c.info('Trying to reconnect');
                                        if (!this_1._connecting) {
                                            return [2 /*return*/, { value: void 0 }];
                                        }
                                        return [3 /*break*/, 5];
