...
var AbstractConnection_1 = require("./AbstractConnection");
var isomorphic_ws_1 = require("@d-fischer/isomorphic-ws");
            ...
            return tslib_1.__generator(this, function (_b) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this._socket.onclose = function (e) {
                            ...
                            (_a = _this._logger) === null || _a === void 0 ? void 0 : _a.trace("WebSocketConnection onClose wasConnected:" + wasConnected + " wasClean:" + e.wasClean);
...
}(AbstractConnection_1.AbstractConnection));
