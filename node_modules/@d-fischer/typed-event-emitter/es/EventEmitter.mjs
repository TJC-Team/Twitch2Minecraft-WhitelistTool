...
var EventEmitter = /** @class */ (function () {
    ...
    EventEmitter.prototype.emit = function (event) {
        ...
        if (this._eventListeners.has(event)) {
            try {
                for (var _c = __values(this._eventListeners.get(event)), _d = _c.next(); !_d.done; _d = _c.next()) {
        ...
        if (this._internalEventListeners.has(event)) {
            try {
                for (var _e = __values(this._internalEventListeners.get(event)), _f = _e.next(); !_f.done; _f = _e.next()) {
