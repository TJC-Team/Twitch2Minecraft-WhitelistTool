...
export function createMessage(type, params, prefix, tags, serverProperties, isServer) {
    ...
    var parsedParams = {};
    forEachObjectEntry(type.PARAM_SPEC, function (paramSpec, paramName) {
...
var Message = /** @class */ (function () {
    ...
    Message.checkParam = function (param, spec, serverProperties) {
        ...
        if (spec.type === 'channelList') {
            ...
            if (!channels.every(function (chan) { return isChannel(chan, serverProperties.channelTypes); })) {
                return false;
            }
        }
        if (spec.match) {
