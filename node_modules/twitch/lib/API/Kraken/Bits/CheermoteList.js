...
var CheermoteList = /** @class */ (function (_super) {
    tslib_1.__extends(CheermoteList, _super);
    /** @private */
    ...
    CheermoteList.prototype.getCheermoteDisplayInfo = function (name, bits, format) {
        ...
        if (!correctTier) {
            throw new HellFreezesOverError_1.HellFreezesOverError("Cheermote \"" + name + "\" does not have an applicable tier for " + bits + " bits");
        }
        return {
...
exports.CheermoteList = CheermoteList;
