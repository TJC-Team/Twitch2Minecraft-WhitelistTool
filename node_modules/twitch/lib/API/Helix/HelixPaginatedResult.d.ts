...
/** @private */
export declare function createPaginatedResult<I extends object, O extends new (data: I, client: ApiClient) => any>(response: HelixPaginatedResponse<I>, type: O, client: ApiClient): HelixPaginatedResult<ConstructedType<O>>;
/** @private */
export declare function createPaginatedResultWithTotal<I extends object, O extends new (data: I, client: ApiClient) => any>(response: HelixPaginatedResponseWithTotal<I>, type: O, client: ApiClient): HelixPaginatedResultWithTotal<ConstructedType<O>>;
