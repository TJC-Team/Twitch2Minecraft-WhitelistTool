...
var HelixChannelPointsApi = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.callApi({
                            ...
                            url: 'channel_points/custom_rewards/redemptions',
                            scope: 'channel:read:redemptions',
                            query: tslib_1.__assign({ broadcaster_id: UserTools_1.extractUserId(broadcaster), reward_id: rewardId, status: status, sort: filter.newestFirst ? 'NEWEST' : 'OLDEST' }, HelixPagination_1.makePaginationQuery(filter))
                        })];
                    case 1:
                        result = _a.sent();
    ...
    HelixChannelPointsApi.prototype.getRedemptionsForBroadcasterPaginated = function (broadcaster, rewardId, status, filter) {
        ...
        }, this._client, function (data) { return new HelixCustomRewardRedemption_1.HelixCustomRewardRedemption(data, _this._client); });
    };
    /**
